...
<!--                    <div>-->
<!--                        <a href="/about-books.php?id=--><?php //= $book['id'] ?><!--" aria-placeholder="Sobre o livro" class="font-semibold text-emerald-500 hover:text-emerald-700">--><?php //= $book['title'] ?><!--</a>-->
<!--                        <div class="text-xs font-light">--><?php //= $book['author'] ?><!--</div>-->
<!--                        <div class="text-sm font-bold "> ⭐ ⭐ ⭐ ⭐ ⭐</div>-->
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="flex font-light ">--><?php //= $book['description'] ?><!--</div>-->
<!--            </div>-->
<!--            --><?php //endforeach; ?>
<!--        </section>-->
<!--    </main>-->
